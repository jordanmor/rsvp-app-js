    ...
    sld_args.slide.forEach(function(vvv, iii) {
      ...
      if (n > 1) {
        ...
        setTimeout(function() {
          ...
          document.querySelector(selector).style.background = "linear-gradient(90deg, #d4eece, #55b3d0, #1e7eb7), url('" + vvv + "') no-repeat";
          ...
          document.querySelector(selector).style.backgroundBlendMode = "multiply";
